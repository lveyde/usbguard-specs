...
%changelog
* Thu Sep 15 2022 Lev Veyde <lveyde@redhat.com> - 1.0.0-11.el9
- Modified the selinux-policy dependency handling to use explicit version

* Fri Apr 29 2022 Sandro Bonazzola <sbonazzo@redhat.com> - 1.0.0-10.1.el9
- Rebuilding for CentOS Virtualization SIG due to protobuf soname bump in
  protobuf-3.19.0-2.el9s from Ceph SIG
